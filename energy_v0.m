function [KE, PE] = energy_v0(t_val)
...
I1 = (m1/12)*[l4^2 + h^2, 0 ,0; 0, l3^2 + h^2, 0; 0, 0, l2^2 + l4^2];
I2 = (m2/12)*[w^2 + h^2, 0 ,0; 0, l1^2 + h^2, 0; 0, 0, l2^2 + w^2];
I3 = (m3/12)*[w^2 + h^2, 0 ,0; 0, l2^2 + h^2, 0; 0, 0, l3^2 + w^2];
I4 = (m4/12)*[w^2 + h^2, 0 ,0; 0, l5^2 + h^2, 0; 0, 0, l4^2 + w^2];
I5 = (m5/12)*[w^2 + h^2, 0 ,0; 0, l2^2 + h^2, 0; 0, 0, l5^2 + w^2];
I6 = (m6/12)*[w^2 + h^2, 0 ,0; 0, l1^2 + h^2, 0; 0, 0, l6^2 + w^2];
I7 = (m7/12)*[l4^2 + h^2, 0 ,0; 0, l3^2 + h^2, 0; 0, 0, l7^2 + l4^2];
