...
x_c1(1) = x_e(1) - (l1+l2)*sin(phi_val);
x_c1(3) = x_e(3) + (l1+l2)*cos(phi_val);
...
if(t<=tm)
    x_b(2) = x_e(2) - Kd*l1*sin(Q_val) - (l5); % trajectory of Q will handle the appropriate variations
    x_c1(2) = x_e(2) - Kd*(l1+l2)*sin(Q_val) - (l5);
    x_a(2) = x_e(2) - (l5);
    x_p(2) = x_e(2) - (l5);
    
elseif(t>tm)
    x_b(2) = x_e(2) - Kd*l1*sin(Q_val);
    x_c1(2) = x_e(2) - Kd*(l1+l2)*sin(Q_val);
    x_a(2) = x_e(2);
    x_p(2) = x_e(2);
end